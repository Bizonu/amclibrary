;--------------------------------
;  File:        Build_Setup_x64.nsi
;  Description: The build script for the x64 setup.
...
;General
  ...
  ;Name and file
  Name "AMC Tools"
  OutFile "AMC Tools Setup x64.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES64\AMC Tools"
...
Section "Flash Player Install" SecFlashPlayer
 ...
 SetOutPath "$TEMP"
 File "..\redist\x64\install_flashplayer11x64ax_gtbd_aih.exe"
 DetailPrint "Running Flash Player ActiveX Setup..."
 ExecWait '"$TEMP\install_flashplayer11x64ax_gtbd_aih.exe"' $FlashPlayerSetupError
...
Section "Install Section" SecInstall
  ...
  FILE "..\redist\x64\*.dll"
  FILE "..\bin\x64\Release\AES_CPU.amc"
  FILE "..\bin\x64\Release\AES_GPU_DX10.amc"
  FILE "..\bin\x64\Release\AMCLibrary.dll"
  FILE "..\bin\x64\Release\AMC Tool.exe"
  FILE "..\bin\x64\Release\AMC Tool Results Viewer.exe"
